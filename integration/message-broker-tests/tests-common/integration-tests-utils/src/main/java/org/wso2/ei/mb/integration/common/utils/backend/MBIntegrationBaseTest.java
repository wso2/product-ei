...
package org.wso2.ei.mb.integration.common.utils.backend;
...
public class MBIntegrationBaseTest {
    ...
    protected void restartServerWithH2MemMode() throws Exception {
        ...
        serverManager.applyConfiguration(new File(FrameworkPathUtil.getSystemResourceLocation() + File.separator +
                        ...
                        "broker.xml"),
                new File(getBrokerConfigurationPath()),
                true, true);
    }
    ...
    protected String getBrokerConfigurationPath() {
        return ServerConfigurationManager.getCarbonHome() + File.separator + "wso2" +
