...
public class Soap11FaultOutSequenceTestCase extends ESBIntegrationTest {
    ...
    public void uploadSynapseConfig() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/fault/soap11_fault_out_sequence_synapse.xml");
    }
    ...
    public void testSOAP11FaultFromOutSequence() throws AxisFault, XPathExpressionException {
        try {
            ...
            assertEquals(expected.getReason(), "Custom ERROR Message - Soap11FaultOutSequenceTestCase", "Custom ERROR Message mismatched");
