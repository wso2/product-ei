...
public class IntroductionToCallMediatorTestCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/call/synapse1.xml");
    }

    @Test(groups = {"wso2.esb"})
    public void introductionToCallMediatorTestCase() throws AxisFault {
