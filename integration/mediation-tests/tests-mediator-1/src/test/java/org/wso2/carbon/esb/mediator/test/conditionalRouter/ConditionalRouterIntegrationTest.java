   ...
   /* https://wso2.org/jira/browse/STRATOS-2239*/
    ...
    public void conditionalRouterMediatorWithContinueAfterFalseTest() throws Exception {
        ...
        try {
            response2 = axis2Client
                    .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("ConRoutingWithContinueAfterFalseProxy"), null,
                            "WSO2");
    ...
    public void conditionalRouterMediatorWithManyRoutesTest() throws Exception {
        ...
        OMElement response = client.sendSimpleStockQuoteRequest(
                getProxyServiceURLHttp("conditionalRouterWithManyRoutesProxy") + "?qparam1=qpv_foo", null, "WSO2");
    ...
    public void conditionalRouterMediatorWithEqualUrlTest() throws Exception {
        ...
        try {
            response = client
                    .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("ServiceProxy1") + "?qparam1=qpv_foo", null,
                            "WSO2");
            Assert.fail("This Request Should throw AxisFault");
        } catch (AxisFault e) {
        }
    ...
    public void conditionalRouterMediatorWithEqualHeaderTest() throws Exception {
        ...
        try {
            response = client
                    .sendSimpleStockQuoteRequest(getProxyServiceURLHttp("ServiceProxy2") + "?qparam1=qpv_foo", null,
                            "WSO2");
            Assert.fail("This Request Should throw AxisFault");
        } catch (AxisFault e) {
        }
