...
public class CallMediatorInNestedFilterTestCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/call/synapse5.xml");
    }

    @Test(groups = {"wso2.esb"})
    public void callMediatorInNestedFilterTestCase() throws AxisFault {
