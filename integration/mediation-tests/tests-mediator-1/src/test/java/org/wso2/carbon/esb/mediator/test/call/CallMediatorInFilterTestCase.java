...
public class CallMediatorInFilterTestCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/call/synapse4.xml");
    }

    @Test(groups = {"wso2.esb"})
    public void callMediatorInFilterTestCase() throws AxisFault {
