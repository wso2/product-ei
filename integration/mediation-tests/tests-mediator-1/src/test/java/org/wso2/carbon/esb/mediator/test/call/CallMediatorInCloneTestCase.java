...
public class CallMediatorInCloneTestCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/call/synapse10.xml");
    }

    @Test(groups = {"wso2.esb"})
    public void callMediatorInCloneTestCase() throws AxisFault {
