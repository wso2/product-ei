...
public class UrlReWriteByContext extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true)
    public void uploadSynapseConfig() throws Exception {
        super.init();
        verifyProxyServiceExistence("urlRewriteByUrlContextTestProxy");
    }
    ...
    public void reWriteContext(String addUrl) throws AxisFault {
        ...
        response = axis2Client.sendSimpleStockQuoteRequest(
                getProxyServiceURLHttp("urlRewriteByUrlContextTestProxy"),
                addUrl,
                "IBM");
