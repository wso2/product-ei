...
public class Soap11FaultActorTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true)
    public void uploadSynapseConfig() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/fault/soap11_fault_actor_synapse.xml");
    }


    @Test(groups = {"wso2.esb"}, description = "Creating SOAP1.1 fault Actor test")
    public void testSOAP11FaultActor() throws AxisFault {
        ...
        try {
            ...
            assertEquals(expected.getReason(), "Soap11FaultActorTestCase", "Fault Reason Mismatched");
