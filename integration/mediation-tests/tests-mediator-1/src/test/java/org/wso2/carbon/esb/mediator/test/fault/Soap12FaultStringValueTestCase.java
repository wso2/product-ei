...
public class Soap12FaultStringValueTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true)
    public void uploadSynapseConfig() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/fault/soap12_fault_string_value_synapse.xml");
    }
    ...
    public void testSOAP12FaultStringValue() throws AxisFault {
        try {
            ...
            assertEquals(expected.getReason(), "Custom ERROR Message - Soap12FaultStringValueTestCase", "Custom ERROR Message mismatched");
