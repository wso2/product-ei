...
public class Soap12FaultCodeMustUnderstandTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true)
    public void uploadSynapseConfig() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/fault/soap12_fault_code_MustUnderstand_synapse.xml");
    }
    ...
    public void     testSOAP12FaultCodeMustUnderstand() throws AxisFault {
        ...
        try {
            ...
            assertEquals(expected.getReason(), "Soap12FaultCodeMustUnderstandTestCase", "Fault Reason Mismatched");
