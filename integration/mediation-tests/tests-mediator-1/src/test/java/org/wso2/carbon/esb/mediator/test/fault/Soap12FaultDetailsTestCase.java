...
public class Soap12FaultDetailsTestCase extends ESBIntegrationTest {
    @BeforeClass(alwaysRun = true)
    public void uploadSynapseConfig() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/fault/soap12_fault_detail_synapse.xml");
    }
    ...
    public void testSOAP12FaultDetail() throws AxisFault {
        try {
            ...
            assertEquals(expected.getReason(), "Soap12FaultDetailsTestCase", "Fault Reason Mismatched");
