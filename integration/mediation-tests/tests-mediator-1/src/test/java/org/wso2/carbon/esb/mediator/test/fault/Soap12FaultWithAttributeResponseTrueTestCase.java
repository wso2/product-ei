...
public class Soap12FaultWithAttributeResponseTrueTestCase extends ESBIntegrationTest {
    ...
    public void uploadSynapseConfig() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/fault/soap12_fault_set_response_true_synapse.xml");
    }
    ...
    public void testSOAP12FaultAttributeResponseTrue() throws AxisFault {
        try {
            ...
            assertEquals(expected.getReason(), "Custom ERROR Message - Soap12FaultWithAttributeResponseTrueTestCase", "Custom ERROR Message mismatched");
