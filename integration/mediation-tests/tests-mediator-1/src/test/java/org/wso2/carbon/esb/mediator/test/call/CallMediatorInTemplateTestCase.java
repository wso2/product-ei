...
public class CallMediatorInTemplateTestCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/call/synapse9.xml");
    }

    @Test(groups = {"wso2.esb"})
    public void callMediatorInTemplateTestCase() throws AxisFault {
