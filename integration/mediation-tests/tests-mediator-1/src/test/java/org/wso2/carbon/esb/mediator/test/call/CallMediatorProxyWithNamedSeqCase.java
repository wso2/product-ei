...
public class CallMediatorProxyWithNamedSeqCase extends ESBIntegrationTest {

    @BeforeClass(alwaysRun = true)
    public void setEnvironment() throws Exception {
        super.init();
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/call/synapse19.xml");
    }

    @Test(groups = {"wso2.esb"})
    public void callMediatorProxyWithNamedSeqCase() throws AxisFault {
