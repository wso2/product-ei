...
/**
 * This class tests filter mediator behaviour with xpaths for JSON requests
 */
public class FilterFromXpathTestCase extends ESBIntegrationTest {
    ...
    @Test(groups = {"wso2.esb"}, description = "Tests with filter mediator - xpath Scenario Filter condition False",
            dependsOnMethods = "testJSONFilterFromXpathConditionTrueTestScenario")
