...
public class SetHostHttpHeaderTestCase extends ESBIntegrationTest {
    ...
    public void testSetHostHttpHeaderTestCase() throws Exception {
        verifyProxyServiceExistence("HttpHostHeaderSetTestProxy");
        verifyProxyServiceExistence("HttpHostHeaderTestProxy");
        OMElement response;
    ...
    public void testSetHostHttpHeaderWithPortTestCase() throws Exception {
        verifyProxyServiceExistence("HttpHostHeaderSetPortTestProxy");
        verifyProxyServiceExistence("HttpHostHeaderTestPortTestProxy");
        OMElement response;
