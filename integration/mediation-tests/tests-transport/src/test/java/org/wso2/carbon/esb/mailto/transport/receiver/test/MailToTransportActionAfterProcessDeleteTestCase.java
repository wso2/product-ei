...
/**
 * This class is to test delete email in mailbox after receiving email to ESB successfully.
 */
public class MailToTransportActionAfterProcessDeleteTestCase extends ESBIntegrationTest {
    ...
    @Test(groups = {"wso2.esb"}, description = "Test email transport action after process delete",
            dependsOnMethods = {"testEmailReceivedActionAfterProcessDelete"})
    public void testEmailTransportActionAfterProcessDelete() throws ESBMailTransportIntegrationTestException {
