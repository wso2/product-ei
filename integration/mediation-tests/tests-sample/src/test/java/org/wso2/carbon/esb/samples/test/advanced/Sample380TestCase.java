...
public class Sample380TestCase extends ESBSampleIntegrationTest {
    ...
    @Test(groups = "wso2.esb",
            description = "Specify a well qualifies class name, load the properties and mediate a message")
    public void testSpecifyClsLoadPropertiesMediateMsg() throws Exception {
