...
public class Sample430TestCase extends ESBIntegrationTest {
    ...
    public void TestDynamicEndPoints() throws AxisFault, XPathExpressionException {
        ...
        OMElement response = axis2Client.sendSimpleStockQuoteRequest(getMainSequenceURL(),
                getBackEndServiceUrl(ESBTestConstant.SIMPLE_STOCK_QUOTE_SERVICE), "IBM");    // send the simplestockquote request. service url is set at the synapse
