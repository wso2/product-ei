...
public class SecurityTransformationProxyForPolicy3BackEndTestCase extends ESBIntegrationTest {
    private final String serviceName = "StockQuoteSecurityTransformProxyToPolicy3";
    ...
    public void setEnvironment() throws Exception {
        ...
        resourceAdmin.addResource("/_system/config/securityTransform/scenario3-policy.xml", "application/xml", "dss"
                , new DataHandler(new URL("file:///" + policyPath + "scenario3-policy.xml")));

        updateESBConfiguration(SecureEndpointSetter.setEndpoint(
                "/artifacts/ESB/proxyconfig/proxy/secureProxy/security_transformation_proxy_for_policy3_backend.xml"));
...
/*
    @Test(groups = {"wso2.dss"}, description = "Provides Authentication. Clients have Username Tokens. Backend is secured using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 2 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 3 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 4 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 5 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 6 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 7 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 8 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 9 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 10 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 11 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 12 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 13 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 14 and secure back end using policy 3")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 15 and secure back end using policy 3")
