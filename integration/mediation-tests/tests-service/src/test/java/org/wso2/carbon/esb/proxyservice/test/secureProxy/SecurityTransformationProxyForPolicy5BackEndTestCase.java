...
public class SecurityTransformationProxyForPolicy5BackEndTestCase extends ESBIntegrationTest {
    private final String serviceName = "StockQuoteSecurityTransformProxyToPolicy5";
    ...
    public void setEnvironment() throws Exception {
        ...
        resourceAdmin.addResource("/_system/config/securityTransform/scenario5-policy.xml", "application/xml", "dss"
                , new DataHandler(new URL("file:///" + policyPath + "scenario5-policy.xml")));

        updateESBConfiguration(SecureEndpointSetter.setEndpoint(
                "/artifacts/ESB/proxyconfig/proxy/secureProxy/security_transformation_proxy_for_policy5_backend.xml"));
...
/*
    @Test(groups = {"wso2.dss"}, description = "Provides Authentication. Clients have Username Tokens. Backend is secured using policy 5")
    public void securityPolicy1() throws Exception {
        ...
        OMElement response;
        for (int i = 0; i < 5; i++) {
            response = secureServiceClient.sendSecuredStockQuoteRequest(userInfo, getProxyServiceURLHttps(serviceName), policyId, symbol);
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 2 and secure back end using policy 5")
    public void securityPolicy2() throws Exception {
        ...
        OMElement response;
        for (int i = 0; i < 5; i++) {
            response = secureServiceClient.sendSecuredStockQuoteRequest(userInfo, getProxyServiceURLHttp(serviceName), policyId, symbol);
            verifyResponse(response);
        }
        log.info("Non-repudiation verified");
    }

    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 3 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 4 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 5 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 6 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 7 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 8 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 9 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 10 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 11 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 12 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 13 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 14 and secure back end using policy 5")
    ...
    @Test(groups = {"wso2.dss"}, description = "Secure request using policy 15 and secure back end using policy 5")
