...
public class SecurityTransformationProxyForPolicy6BackEndTestCase extends ESBIntegrationTest {
    ...
    public void setEnvironment() throws Exception {
        ...
        resourceAdmin.addResource("/_system/config/securityTransform/scenario6-policy.xml", "application/xml", "dss"
                , new DataHandler(new URL("file:///" + policyPath + "scenario6-policy.xml")));

        updateESBConfiguration(SecureEndpointSetter.setEndpoint(
                "/artifacts/ESB/proxyconfig/proxy/secureProxy/security_transformation_proxy_for_policy6_backend.xml"));
