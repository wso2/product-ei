...
/**
 * This test case verifies that, mediation with inline NashornJs scripts happens correctly.
 */
public class InlineNashornJsFunctionsForBothInAndOutTestCase extends ESBIntegrationTest {
    ...
    public void testInvokeSequence() throws Exception {
        ...
        assertEquals(response.getFirstElement().getText(), "inlineTest", "Fault value mismatched");
