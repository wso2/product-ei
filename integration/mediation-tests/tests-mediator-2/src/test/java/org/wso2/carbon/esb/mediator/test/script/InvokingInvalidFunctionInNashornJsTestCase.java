...
/**
 * This test case verifies that, AxisFault thrown when non-existing function is invoked in a Nashorn script.
 */
public class InvokingInvalidFunctionInNashornJsTestCase extends ESBIntegrationTest {
    ...
    public void testInvokeNonExistingFunc() throws AxisFault {
        axis2Client.sendCustomQuoteRequest(getProxyServiceURLHttp
                ("nashornJsInvokeInvalidFunctionTestProxy"), null, "Invalid");
    }
