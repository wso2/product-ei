...
public class PropertyPersistenceDeletingTestCase extends ESBIntegrationTest{
    ...
    public void testMediationPropertyPersistenceDeleting()
            throws Exception{
        ...
        loadESBConfigurationFromClasspathIfNotExists("/artifacts/ESB/mediatorconfig/class/class_property_persistence_three_properties.xml");
