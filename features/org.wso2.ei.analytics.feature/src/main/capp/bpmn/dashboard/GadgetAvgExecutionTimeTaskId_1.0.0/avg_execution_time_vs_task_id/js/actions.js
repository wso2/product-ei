...
function drawGraph() {
    ...
    if (userId != '') {
        ...
        $.ajax({
            type: 'POST',
            url: '/portal/controllers/apis/bpmn-api/user_level_avg_time_vs_task_id.jag',
...
function loadUserList(dropdownId) {
    ...
    $.getJSON("/portal/store/carbon.super/fs/gadget/avg_execution_time_vs_task_id/js/meta-data-avgExeTimeVsTaskID.json.js", function (result) {
