...
public class PreAxis2ConfigItemListener implements BundleListener {
    private static Log log = LogFactory.getLog(org.wso2.carbon.core.init.PreAxis2ConfigItemListener.class);
    ...
    private BundleHolder carbonServerManager;
    private boolean listenerRegistered;

    public PreAxis2ConfigItemListener(BundleContext bundleContext, BundleHolder carbonServerManager) {
