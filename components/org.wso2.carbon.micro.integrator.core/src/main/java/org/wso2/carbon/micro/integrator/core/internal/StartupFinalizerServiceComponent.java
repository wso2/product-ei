 ...
 *
 * @scr.component name="org.wso2.carbon.micro.integrator.core.internal.StartupFinalizerServiceComponent"
 * immediate="true"
...
public class StartupFinalizerServiceComponent implements ServiceListener {
    private static final Log log = LogFactory.getLog(org.wso2.carbon.core.internal.StartupFinalizerServiceComponent.class);
    ...
    private void completeInitialization(BundleContext bundleContext) {
        ...
        CoreComponent.startup();
        CoreComponent.notifyAfter();
    ...
    private void printInfo() {
        ...
        try {
            log.info("Server           :  " + CoreComponent.getServerConfigurationService().getFirstProperty("Name") + "-" +
                    CoreComponent.getServerConfigurationService().getFirstProperty("Version"));
        } catch (Exception e) {
