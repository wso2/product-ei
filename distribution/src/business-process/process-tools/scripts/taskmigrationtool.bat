...
if exist "%CARBON_HOME%\bin\taskmigrationtool.bat" goto okHome
...
rem FOR %%C in ("%CARBON_HOME%\wso2\components\lib\*.jar") DO set CARBON_CLASSPATH=!CARBON_CLASSPATH!;".\repository\components\lib\%%~nC%%~xC"
rem FOR %%E in ("%CARBON_HOME%\wso2\components\plugins\*.jar") DO set CARBON_CLASSPATH=!CARBON_CLASSPATH!;".\repository\components\plugins\%%~nE%%~xE"

rem ----- Execute The Requested Command ---------------------------------------
set _RUNJAVA="%JAVA_HOME%\bin\java"

set CARBON_CLASSPATH=.\lib;%CARBON_CLASSPATH%
set CARBON_CLASSPATH_CUSTOM=%CARBON_HOME%\wso2\components\plugins\*;%CARBON_HOME%\wso2\components\lib\*
