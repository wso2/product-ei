...
if not exist "%CARBON_HOME%\wso2\business-process\bin\version.txt" goto noServerHome
...
:startServer
%CARBON_HOME%\wso2\business-process\bin\wso2server.bat %* -Dprofile="business-process-default"
