 ...
 */
public class ScheduleCustomJavaTaskWithCronTest extends Scenario14TestBase {

    @BeforeClass()
    public void init() throws Exception {
        super.init(System.getProperty("invocation.uuid") + "-custom-cron");
    }
     ...
     */
    @Test(description = "14.2.2.1")
    public void testScheduleCustomJavaTaskWithCron() throws Exception {
        super.executeTest();
    }
