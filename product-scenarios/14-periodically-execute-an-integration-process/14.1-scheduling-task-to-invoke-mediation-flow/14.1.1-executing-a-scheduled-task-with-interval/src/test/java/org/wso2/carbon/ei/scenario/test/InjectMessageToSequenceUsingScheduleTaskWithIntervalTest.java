 ...
 */
public class InjectMessageToSequenceUsingScheduleTaskWithIntervalTest extends Scenario14TestBase {

    @BeforeClass()
    public void init() throws Exception {
        super.init(System.getProperty("invocation.uuid") + "-interval");
    }
