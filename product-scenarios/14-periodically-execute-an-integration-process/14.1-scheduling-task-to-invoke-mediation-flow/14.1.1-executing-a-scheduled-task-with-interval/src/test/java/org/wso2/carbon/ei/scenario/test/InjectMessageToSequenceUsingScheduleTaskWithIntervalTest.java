 ...
 */
public class InjectMessageToSequenceUsingScheduleTaskWithIntervalTest extends ScenarioTestBase {
    private static final String INVOCATION_ID = System.getProperty("invocation.uuid") + "-interval";
    private static final String URL = ScenarioConstants.BACKEND_REST_SERVICE1_URL + "invocationCount/" + INVOCATION_ID;

    private static final Log LOG = LogFactory.getLog(InjectMessageToSequenceUsingScheduleTaskWithIntervalTest.class);
