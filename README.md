# WSO2 Enterprise Integrator 6.3.0-m3
...
1. Extract  wso2ei-6.3.0-m3.zip and go to the extracted directory/bin.
...
1. Extract wso2ei-6.3.0-m3 and go to the extracted directory.
2. Go to wso2ei-6.3.0-m3/wso2 directory.
...
- Extract the Product EI distribution created at product-ei/distribution/target/wso2ei-6.3.0-m3.zip in to your
local directory
