# WSO2 Enterprise Integrator 6.3.0-m1
...
1. Extract  wso2ei-6.3.0-m1.zip and go to the extracted directory/bin.
...
1. Extract wso2ei-6.3.0-m1 and go to the extracted directory.
2. Go to wso2ei-6.3.0-m1/wso2 directory.
...
- Extract the Product EI distribution created at product-ei/distribution/target/wso2ei-6.3.0-m1.zip in to your
local directory
