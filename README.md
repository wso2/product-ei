...
1. Extract wso2ei-6.2.0 and go to the extracted directory.
...
- Extract the Product EI distribution created at product-ei/distribution/target/wso2ei-6.2.0.zip in to your
local directory
