...
public class Service {
     ...
     *
     * @param ballerinaASTModelBuilder High level API to build ballerina model
     * @param parameters               parameters needed to end ballerina service
     */
    public static void endOfService(BallerinaASTModelBuilder ballerinaASTModelBuilder,
            Map<Property, String> parameters) {
        ballerinaASTModelBuilder
                .endOfService(parameters.get(Property.SERVICE_NAME), parameters.get(Property.PROTOCOL_PKG_NAME));
    }
