...
public class RespondMediatorWrapper extends MediatorWrapper {
    ...
    private RespondMediator respondMediator;

    public RespondMediatorWrapper(Mediator original) {
        super(original);
        if (original instanceof RespondMediator) {
            this.respondMediator = (RespondMediator) original;
        }
    }

    @Override
    public void accept(Visitor visitor) {
        visitor.visit(respondMediator);
    }
}
